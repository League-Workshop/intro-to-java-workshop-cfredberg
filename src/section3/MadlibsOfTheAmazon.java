...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String BFF = JOptionPane.showInputDialog("Piranhas are more " + adj + " during the day, so cross the river at night.");
		// night. Piranhas are attracted to fresh [type of liquid] and will most
		JOptionPane.showMessageDialog("Piranhas are attracted to fresh " + liquid + " and will most likely take a bite out of your " + body + " if you " + verb + ". Whatever you do, if you have an open wound, try to find another way to get back to the ")
